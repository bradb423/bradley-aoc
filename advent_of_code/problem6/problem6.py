...
def turn_on(instruction,lightgrid):
    for i in range(instruction[0],instruction[2]+1): # the +1 is because of python loops always stopping one before you actually ask them to
...
#### implementing part 2
instructions = parser(filepath)
resulting_lightgrid = new_reading_instructions(instructions= instructions, lightgrid= lightgrid)
